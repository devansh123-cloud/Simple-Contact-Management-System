...
def validate_phone_number(phone_number):
    ...
    Returns the cleaned phone number if valid, None otherwise.
    This is a basic example; real-world validation might be more complex.
    """
    # A simple regex for a 10-digit number, optionally with a leading + and country code
    # This regex allows for various formats including spaces, hyphens, and parentheses
    # and accounts for international numbers (e.g., +1 (123) 456-7890)
    ...
    if phone_pattern.fullmatch(phone_number):
        # Remove non-numeric characters for consistent storage if desired,
        # but for display, the original format might be preferred.
        # For simplicity, we'll return the original if it matches the pattern.
        return phone_number
    return None
...
def validate_email(email):
    ...
    This regex is a common general-purpose email validation.
    """
